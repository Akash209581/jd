...
const ResumeBuilderContent = () => {
  ...
  return (
    <div className="h-screen w-full bg-background flex justify-center items-center p-4 md:p-8">
      {/* Main Container */}
      <div className="w-full h-full max-w-[90%] md:max-w-[95%] xl:max-w-[1800px] border border-zinc-800 bg-zinc-950/80 backdrop-blur-md rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header Section */}
        <div className="border-b border-zinc-800/80 p-6 md:p-8 bg-zinc-900/10 no-print">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
              ...
              <h1 className="font-sans text-3xl md:text-4xl font-extrabold text-zinc-100 tracking-tight leading-none uppercase bg-gradient-to-r from-zinc-100 to-zinc-400 bg-clip-text text-transparent">
                {t('nav.builder')}
              </h1>
              <div className="mt-3 flex items-center gap-3">
                <p className="text-xs font-mono text-violet-400 uppercase tracking-wide font-bold">
                  {'// '}
                  {resumeId ? t('builder.editMode') : t('builder.createAndPreview')}
                </p>
                {hasUnsavedChanges && (
                  <span className="flex items-center gap-1 text-xs font-mono text-amber-400 bg-amber-500/10 px-2 py-1 border border-amber-500/20 rounded-lg">
        ...
        {/* Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 bg-zinc-800/50 gap-[1px] flex-1 min-h-0">
          {/* Left Panel: Editor */}
          <div className="bg-background p-6 md:p-8 overflow-y-auto no-print">
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="flex items-center gap-2 border-b border-zinc-850 pb-2">
                ...
                <h2 className="font-sans text-sm font-bold uppercase tracking-wider text-zinc-300">
              ...
              {activeTab === 'jd-match' && (
                <div className="space-y-4">
                  <div className="border border-zinc-800 bg-zinc-900/50 rounded-xl p-4 text-zinc-300">
                    <h3 className="font-mono text-sm font-bold uppercase mb-2 text-zinc-200">
                  ...
                  <div className="border border-zinc-800 bg-zinc-900/30 rounded-xl p-4 text-zinc-300">
                    <h3 className="font-mono text-sm font-bold uppercase mb-2 text-zinc-200">
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      {(() => {
                        ...
                        return (
                          <>
                            {parts[0]}
                            <mark className="bg-yellow-500/20 text-yellow-300 border border-yellow-500/20 rounded px-1">
        ...
        {/* Footer */}
        <div className="p-4 bg-zinc-900/30 flex justify-between items-center font-mono text-xs text-zinc-400 border-t border-zinc-800/80 no-print">
